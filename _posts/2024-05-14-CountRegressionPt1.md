...
$$
log(\lambda_i) = \beta_0 + \beta x_{i1} + \beta_2 x_{i2} + \ldots + \beta_p x_ip 
$$ where $\lambda_i$ is the expected count for the $i$-th observation and $\beta_0, \beta_1, \ldots, \beta_p$ are our regression coefficients. 
